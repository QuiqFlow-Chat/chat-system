...
import { IUserCreateParameters, IUserLoginParameters } from '@/types/dtosInterfaces/userDtos';
...
export class AuthController {
  ...
  public async register(req: Request, res: Response, _next: NextFunction) {
    const parameters: IUserCreateParameters = req.body;
  ...
  public async login(req: Request, res: Response, _next: NextFunction) {
    const parameters: IUserLoginParameters = req.body;
